...
public class ResourceController {
	...
	public WebResponse getAllRes(HttpSession session, MyPage myPage) {
		...
		JsonPage<ResourceVo> resList = resourceService.getAllRes(myPage, sessionUser.getId(), sessionUser.getType());
	...
	@ResponseBody
	public WebResponse getAllResourceAndEnv(Long appId, Long envId) {
		JsonPage<ResourceVo> allResourceAndEnv = resourceService.getAllResourceAndEnv(appId, envId);
	...
	public WebResponse addRelativeResource(Long appId, Long envId, Long resId, Long resEnvId, String itemValue) {
	...
	public WebResponse getRelativeResource(Long appId, Long envId) {
		return new WebResponse(0, Const.DATA_SUCCEED, resourceService.getRelativeResource(appId, envId));
	}

//	@ResponseBody
//	@RequestMapping(value = "/getBindItem")    //前后端未分离时调用方法
	...
	public WebResponse getBindItem(Long appId, Long envId, Long resId, Long resEnvId) {
		return new WebResponse(0, Const.DATA_SUCCEED, resourceService.getBindItem(appId, envId, resId, resEnvId));
	}
